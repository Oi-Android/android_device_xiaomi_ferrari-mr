...
TARGET_RECOVERY_DENSITY := nhdpi


# Flags
COMMON_GLOBAL_CFLAGS += -DNEW_ION_HEAP -DRECOVERY_BGRA -DRECOVERY_RGBX -DQCOM_HARDWARE -DQCOM_BSP -DNO_SECURE_DISCARD -DUSE_RIL_VERSION_10
COMMON_GLOBAL_CPPFLAGS += -DNEW_ION_HEAP -DRECOVERY_BGRA -DRECOVERY_RGBX -DQCOM_HARDWARE -DQCOM_BSP -DNO_SECURE_DISCARD -DUSE_RIL_VERSION_10
